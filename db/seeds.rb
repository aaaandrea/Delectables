...
Recipe.create({name: 'great food', ingredients: 'food', directions: 'blahblah', img: 'blah', tag_id: 1, user_id: 1})
Recipe.create({name: 'food', ingredients: 'food', directions: 'blahblah', img: 'blah', tag_id: 2, user_id: 1})
